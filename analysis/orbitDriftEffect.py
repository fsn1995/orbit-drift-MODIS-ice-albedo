...
fig, ax = plt.subplots(2,4, sharey='row', figsize=(23,11)) #figsize=(8,7)

sns.lineplot(ax=ax[0,0], data=dfaws, x="time", y="PROMICE", label="PROMICE", color="k")
sns.scatterplot(ax=ax[0,0], data=dfmod, x="time", y="MOD", label="MOD10", alpha=0.5)
sns.scatterplot(ax=ax[0,0], data=dfmyd, x="time", y="MYD", label="MYD10", alpha=0.5)
sns.scatterplot(ax=ax[0,0], data=dfhsa, x="time", y="HSA", label="HSA", alpha=0.5)
sns.scatterplot(ax=ax[0,0], data=dfs3, x="time", y="S3", label="S3", alpha=0.5, color="purple")
ax[0,0].set_xlim(pd.to_datetime("2019-06-01"), pd.to_datetime("2019-08-31"))
ax[0,0].xaxis.set_major_formatter(mdates.DateFormatter('%b-%d'))
ax[0,0].set_ylim(0.25, 1)
sns.move_legend(ax[0,0], "upper left", bbox_to_anchor=(0.65, 1.25), ncol=5)
ax[0,0].set_xticks(ax[0,0].get_xticks()[::2])
ax[0,0].set(xlabel="2019", ylabel="albedo")
ax[0,0].annotate("a)", xy=(0.85, 0.80),  xycoords='axes fraction')

sns.lineplot(ax=ax[0,1], data=dfaws, x="time", y="PROMICE", label="PROMICE", color="k")
sns.scatterplot(ax=ax[0,1], data=dfmod, x="time", y="MOD", label="MOD", alpha=0.5)
sns.scatterplot(ax=ax[0,1], data=dfmyd, x="time", y="MYD", label="MYD", alpha=0.5)
sns.scatterplot(ax=ax[0,1], data=dfhsa, x="time", y="HSA", label="HSA", alpha=0.5)
sns.scatterplot(ax=ax[0,1], data=dfs3, x="time", y="S3", label="S3", alpha=0.5, color="purple")
ax[0,1].set_xlim(pd.to_datetime("2020-06-01"), pd.to_datetime("2020-08-31"))
ax[0,1].xaxis.set_major_formatter(mdates.DateFormatter('%b-%d'))
ax[0,1].set_ylim(0.25, 1)
ax[0,1].legend().remove()
ax[0,1].set_xticks(ax[0,1].get_xticks()[::2])
ax[0,1].set(xlabel="2020", ylabel="")
ax[0,1].annotate("b)", xy=(0.85, 0.80),  xycoords='axes fraction')

sns.lineplot(ax=ax[0,2], data=dfaws, x="time", y="PROMICE", label="PROMICE", color="k")
sns.scatterplot(ax=ax[0,2], data=dfmod, x="time", y="MOD", label="MOD", alpha=0.5)
sns.scatterplot(ax=ax[0,2], data=dfmyd, x="time", y="MYD", label="MYD", alpha=0.5)
sns.scatterplot(ax=ax[0,2], data=dfhsa, x="time", y="HSA", label="HSA", alpha=0.5)
sns.scatterplot(ax=ax[0,2], data=dfs3, x="time", y="S3", label="S3", alpha=0.5, color="purple")
ax[0,2].set_xlim(pd.to_datetime("2021-06-01"), pd.to_datetime("2021-08-31"))
...
ax[0,2].set(xlabel="2021", ylabel="")
ax[0,2].annotate("c)", xy=(0.85, 0.80),  xycoords='axes fraction')

sns.lineplot(ax=ax[0,3], data=dfaws, x="time", y="PROMICE", label="PROMICE", color="k")
sns.scatterplot(ax=ax[0,3], data=dfmod, x="time", y="MOD", label="MOD", alpha=0.5)
sns.scatterplot(ax=ax[0,3], data=dfmyd, x="time", y="MYD", label="MYD", alpha=0.5)
sns.scatterplot(ax=ax[0,3], data=dfhsa, x="time", y="HSA", label="HSA", alpha=0.5)
sns.scatterplot(ax=ax[0,3], data=dfs3, x="time", y="S3", label="S3", alpha=0.5, color="purple")
ax[0,3].set_xlim(pd.to_datetime("2022-06-01"), pd.to_datetime("2022-08-31"))
ax[0,3].xaxis.set_major_formatter(mdates.DateFormatter('%b-%d'))
# ax[0,0].set_ylim(0.25, 1)
ax[0,3].legend().remove()

ax[0,3].set_xticks(ax[0,3].get_xticks()[::2])
ax[0,3].set(xlabel="2022", ylabel="")
ax[0,3].annotate("d)", xy=(0.85, 0.80),  xycoords='axes fraction')

df = pd.merge(left=dfmod, right=dfaws, on=["time"]).dropna()
df = df[(df.time>pd.to_datetime("2019-01-01")) & (df.time<pd.to_datetime("2019-12-31"))]         
sns.regplot(ax=ax[1,0], data=df, x="MOD", y="PROMICE")
ax[1,0].set(xlabel="MOD10", ylabel="PROMICE")
ax[1,0].annotate("e)", xy=(0.85, 0.15),  xycoords='axes fraction')
ax[1,0].set_ylim(0.2, 1)
ax[1,0].set_xlim(0.2, 1)

df = pd.merge(left=dfmod, right=dfaws, on=["time"]).dropna()
df = df[(df.time>pd.to_datetime("2020-01-01")) & (df.time<pd.to_datetime("2020-12-31"))]
sns.regplot(ax=ax[1,1], data=df, x="MOD", y="PROMICE")
ax[1,1].set(xlabel="MOD10", ylabel="")
ax[1,1].annotate("f)", xy=(0.85, 0.15),  xycoords='axes fraction')
ax[1,1].set_ylim(0.2, 1)
ax[1,1].set_xlim(0.2, 1)

df = pd.merge(left=dfmod, right=dfaws, on=["time"]).dropna()
df = df[(df.time>pd.to_datetime("2021-01-01")) & (df.time<pd.to_datetime("2021-12-31"))]
sns.regplot(ax=ax[1,2], data=df, x="MOD", y="PROMICE")
ax[1,2].set(xlabel="MOD10", ylabel="")
ax[1,2].annotate("g)", xy=(0.85, 0.15),  xycoords='axes fraction')
ax[1,2].set_ylim(0.2, 1)
ax[1,2].set_xlim(0.2, 1)

df = pd.merge(left=dfmod, right=dfaws, on=["time"]).dropna()
df = df[(df.time>pd.to_datetime("2022-01-01")) & (df.time<pd.to_datetime("2022-12-31"))]
sns.regplot(ax=ax[1,3], data=df, x="MOD", y="PROMICE")
ax[1,3].set(xlabel="MOD10", ylabel="")
ax[1,3].annotate("h)", xy=(0.85, 0.15),  xycoords='axes fraction')
ax[1,3].set_ylim(0.2, 1)
